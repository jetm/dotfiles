ZF_DEFAULT_OPTS+='--layout=reverse '
FZF_DEFAULT_OPTS+='--info=inline '
FZF_DEFAULT_OPTS+='--height=50% '
FZF_DEFAULT_OPTS+='--multi '
FZF_DEFAULT_OPTS+='--preview-window=:down:90%:hidden '
...
F
export FORGIT_FZF_DEFAULT_OPTS="${FORGIT_FZF_DEFAULT_OPTS} --preview-window=:down:90%:nohidden"
