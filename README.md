...
* Configuration files
    ...
    * [`.screen-256color`](https://github.com/jetm/dotfiles/blob/master/no-stow/terminfo/s/screen-256color)/[`.xterm-256color`](https://github.com/jetm/dotfiles/blob/master/.terminfo/x/xterm-256color) Compiled terminfo entry to support 256 colors in screen/tmux (Old OS like RedHat v5).
